...
export default function HomePage() {
  ...
  const generateShareableContent = (food) => {
    ...
    return {
      title: `Nutrition info for ${food.food_name} | অন্ন - Data`,
      text: `I found nutrition info for ${food.food_name} using অন্ন - Data!\n\n• Calories: ${calories} kcal\n• Protein: ${protein}g\n• Carbs: ${carbs}g\n• Fat: ${fats}g\n\n${food.serving_type} (${food.calories_calculated_for}g)`,
          ...
          <div className="text-center mb-12 relative">
            ...
            >
              ...
              <h1 className="relative text-5xl md:text-7xl font-extrabold text-transparent bg-clip-text bg-gradient-to-r from-indigo-400 via-purple-500 to-indigo-400 mb-4 px-2">
                <span className="font-devanagari">অন্ন - Data</span>
              </h1>
            </motion.div>
            ...
            <div>
              ...
              >
                <h2 className="text-2xl font-bold text-white mb-8 text-center">
                  Discover More with{" "}
                  <span className="font-devanagari bg-gradient-to-r from-indigo-400 to-purple-500 text-transparent bg-clip-text">অন্ন - Data</span>
                </h2>
              ...
              >
                <h2 className="text-2xl font-bold text-white text-center mb-8">
                  Features That Make{" "}
                  <span className="font-devanagari bg-gradient-to-r from-indigo-400 to-purple-500 text-transparent bg-clip-text">অন্ন - Data</span> Special
                </h2>
    ...
    <div className="flex flex-col md:flex-row justify-between items-center gap-8">
      ...
      <div className="space-y-5">
        ...
        <div className="flex gap-4">
          ...
          <a
            href="https://github.com/D-roy-2003"
            className="w-9 h-9 rounded-full bg-slate-800/90 hover:bg-indigo-600/90 flex items-center justify-center transition-colors group"
            aria-label="GitHub"
          >
    ...
    <div className="mt-8 pt-6 border-t border-slate-800/50 flex flex-col md:flex-row justify-between items-center">
      <div className="mb-4 md:mb-0">
        <p className="text-slate-500 text-sm">
          &copy; {new Date().getFullYear()} অন্ন - Data • All rights reserved
        </p>
      </div>
      ...
      <div className="flex items-center">
        <div className="text-slate-500 flex items-center gap-2">
          ...
          <a href="https://x.com/Boomboom_699" target="_blank" rel="noopener noreferrer" className="relative group">
            <span className="bg-gradient-to-r from-indigo-400 to-purple-500 text-transparent bg-clip-text font-semibold text-base">Debangshu Roy</span>
            <span className="text-indigo-400/90">(Team অন্ন - Data)</span>
